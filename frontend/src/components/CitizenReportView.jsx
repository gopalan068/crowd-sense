...
const CATEGORIES = [
  ...
  // ── Gap #2 Fix: Add categories that trigger RED severity on backend ──────
  // Backend assigns critical 'red' severity ONLY to STAMPEDE_RISK and GENERAL_PANIC.
  // Without these, citizen reports could never trigger a red alert.
  {
    id: 'STAMPEDE_RISK',
    label: '🚨 Stampede / Surge Risk',
    severity: 'red',
    bgColor: 'bg-red-100 dark:bg-red-900/60 text-red-700 dark:text-red-300 animate-pulse',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-5 h-5">
